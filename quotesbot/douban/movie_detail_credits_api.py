...
class ToScrapeMovieDetailApi(scrapy.Spider):
    name = 'douban_movie_detail_credits_api'
    # start_urls = [
    #     'https://m.douban.com/rexxar/api/v2/tv/27157689?ck=lvDn&for_mobile=1'
    # ]
    ...
    def start_requests(self):
        for x in get_start_ids():
            yield Request(f'https://m.douban.com/rexxar/api/v2/{x["type"]}/{x["id"]}/credits',
...
def main():
    body = helper.read_mock('movie_detail_credits_api')
    res = parse_body(body)
    print('[yield]', res)
